...
!(function (e, t) {
    ...
    !(function ($) {
        ...
        o.classList.add("c1", "c2"),
            ...
            String.prototype.startsWith || ((c = {}.toString), Object.defineProperty ? Object.defineProperty(String.prototype, "startsWith", { value: h, configurable: !0, writable: !0 }) : (String.prototype.startsWith = h));
        ...
        function b(e, t, i, s) {
            for (var n = ["display", "subtext", "tokens"], o = !1, l = 0; l < n.length; l++) {
                var r = n[l],
                    a = e[r];
                if (a && ((a = a.toString()), "display" === r && (a = a.replace(/<[^>]+>/g, "")), (a = (a = s ? u(a) : a).toUpperCase()), (o = "function" == typeof i ? i(a, t) : "contains" === i ? 0 <= a.indexOf(t) : a.startsWith(t))))
                    break;
            }
            return o;
        }
        ...
        var ee = 0,
            ...
            z = { MENU: "." + T.MENU, DATA_TOGGLE: 'data-bs-toggle="dropdown"' },
            D = {
            ...
            L = {
                    ...
                    if (
                        (e.content
                            ...
                            : ((n.textContent = e.text),
                                e.icon && ((i = D.whitespace.cloneNode(!1)), ((s = (!0 === t ? D.i : D.span).cloneNode(!1)).className = this.options.iconBase + " " + e.icon), D.fragment.appendChild(s), D.fragment.appendChild(i)),
                                e.subtext && (((s = D.subtext.cloneNode(!1)).textContent = e.subtext), n.appendChild(s))),
                            !0 === t)
                    )
                ...
                label: function (e) {
                    ...
                    return (
                        ...
                        e.icon && ((t = D.whitespace.cloneNode(!1)), ((i = D.span.cloneNode(!1)).className = this.options.iconBase + " " + e.icon), D.fragment.appendChild(i), D.fragment.appendChild(t)),
                        e.subtext && (((i = D.subtext.cloneNode(!1)).textContent = e.subtext), s.appendChild(i)),
        ...
        function H(e, t) {
            ...
            p.useDefault || (($.valHooks.select.set = p._set), (p.useDefault = !0)),
                ...
                (this.options = t),
                (this.selectpicker = {
                    main: { data: [], optionQueue: D.fragment.cloneNode(!1), hasMore: !1 },
            ...
            var s = this.each(function () {
                ...
                if (e.is("select")) {
                    ...
                    if ((i.title && (i.placeholder = i.title), t)) {
                        ...
                        (l.template = $.extend({}, H.DEFAULTS.template, $.fn.selectpicker.defaults ? $.fn.selectpicker.defaults.template : {}, o.template, i.template)),
                            (l.source = $.extend({}, H.DEFAULTS.source, $.fn.selectpicker.defaults ? $.fn.selectpicker.defaults.source : {}, i.source)),
            ...
            (H.prototype = {
                ...
                createDropdown: function () {
                    ...
                    var n = "",
                        ...
                        a = "";
                    return (
                        this.options.header && (n = '<div class="' + T.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                        ...
                        (r = '<div class="bs-donebutton"><div class="btn-group"><button type="button" class="btn btn-sm ' + T.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>"),
                        this.options.allowClear && (a = '<span class="close bs-select-clear-selected" title="' + this.options.deselectAllText + '"><span>&times;</span>'),
                        (e =
                            ...
                            a +
                            "</span>" +
                            ("4" <= g.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "</span>") +
                            '</button><div class="' +
                            T.MENU +
                            " " +
                            ("4" <= g.major ? "" : T.SHOW) +
                ...
                createView: function (y, e, t) {
                    ...
                    function E(e, t) {
                        ...
                        if (
                            (void 0 === i && (i = 0),
                                ...
                                (p = g[0] !== x.selectpicker.view.position0 || g[1] !== x.selectpicker.view.position1),
                                void 0 !== x.activeElement &&
                                (t && (x.activeElement !== x.selectedElement && x.defocusItem(x.activeElement), (x.activeElement = void 0)), x.activeElement !== x.selectedElement && x.defocusItem(x.selectedElement)),
                                void 0 !== x.prevActiveElement && x.prevActiveElement !== x.activeElement && x.prevActiveElement !== x.selectedElement && x.defocusItem(x.prevActiveElement),
                                t || p || x.selectpicker.current.hasMore)
                        ) {
                            if (
                                ((f = x.selectpicker.view.visibleElements ? x.selectpicker.view.visibleElements.slice() : []),
                                    (x.selectpicker.view.visibleElements = !1 === l ? x.selectpicker.current.elements : x.selectpicker.current.elements.slice(x.selectpicker.view.position0, x.selectpicker.view.position1)),
                                    x.setOptionStatus(),
                                    (y || (!1 === l && t)) &&
                                    ((g = f),
                                ...
                                x.options.sanitize && v.length && S(v, x.options.whiteList, x.options.sanitizeFn),
                                    !0 === l
                                        ? ((g = 0 === x.selectpicker.view.position0 ? 0 : x.selectpicker.current.data[x.selectpicker.view.position0 - 1].position),
                                            (o = x.selectpicker.view.position1 > s - 1 ? 0 : x.selectpicker.current.data[s - 1].position - x.selectpicker.current.data[x.selectpicker.view.position1 - 1].position),
                                    ...
                                    ((f = p.firstChild.offsetWidth),
                                        t && f < x.sizeInfo.menuInnerInnerWidth && x.sizeInfo.totalMenuWidth > x.sizeInfo.selectWidth
                                            ? (p.firstChild.style.minWidth = x.sizeInfo.menuInnerInnerWidth + "px")
                                            : f > x.sizeInfo.menuInnerInnerWidth &&
                                            ((x.$menu[0].style.minWidth = 0),
                                                (g = p.firstChild.offsetWidth) > x.sizeInfo.menuInnerInnerWidth && ((x.sizeInfo.menuInnerInnerWidth = g), (p.firstChild.style.minWidth = x.sizeInfo.menuInnerInnerWidth + "px")),
                        ...
                        (x.prevActiveElement = x.activeElement),
                            x.options.liveSearch
                                ? y &&
                                t &&
                                (x.selectpicker.view.canHighlight[(l = 0)] || (l = 1 + x.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                    ...
                    (this.selectpicker.isSearching = y),
                        ...
                        (t
                            ...
                            : x.multiple ||
                            ("number" == typeof (t = ((e = x.$element[0]).options[e.selectedIndex] || {}).liIndex) &&
                                !1 !== x.options.size &&
                ...
                setPlaceholder: function () {
                    ...
                    return (
                        ...
                        (this.selectpicker.view.titleOption || (this.selectpicker.view.titleOption = document.createElement("option")),
                            ...
                            (l = (l = window.performance && window.performance.getEntriesByType("navigation")) && l.length ? "back_forward" !== l[0].type : 2 !== window.performance.navigation.type),
                            i &&
                            ((this.selectpicker.view.titleOption.className = "bs-title-option"),
                                (this.selectpicker.view.titleOption.value = ""),
                                (t = !n || (s === o && !1 === n.defaultSelected && void 0 === this.$element.data("selected")))),
                        ...
                        ((t = t || {}).divider = p(e, "divider")),
                            !0 === t.divider
                                ...
                                : ((i = f.length + l),
                                    ...
                                    !1 !== h && (o.selectpicker.optionValuesDataMap[t.value] ? (t = $.extend(o.selectpicker.optionValuesDataMap[t.value], t)) : (o.selectpicker.optionValuesDataMap[t.value] = t)),
                                    f.push(t));
                    }
                    function i(e, t) {
                        var i = t[e],
                        ...
                        if (n.length) {
                            var o,
                                l,
                                r = { display: k(p(w, "label")), subtext: p(i, "subtext"), icon: p(i, "icon"), type: "optgroup-label", optgroupClass: " " + (i.className || ""), optgroup: i };
                ...
                buildList: function (e, t) {
                    ...
                    e
                        ? t
                            ...
                            : (Array.prototype.push.apply(this.selectpicker.main.elements, n), (this.selectpicker.current.elements = this.selectpicker.main.elements))
                        : t
                ...
                render: function (e) {
                                    ...
                                    (this.multiple && 0 < p && d.appendChild(c.cloneNode(!1)),
                                        u.title
                                            ...
                                            : u.content && i.options.showContent
                                                ...
                                                : (i.options.showIcon && (f.icon = u.icon), i.options.showSubtext && !i.multiple && u.subtext && (f.subtext = " " + u.subtext), (f.text = u.text.trim())),
                                        d.appendChild(L.text.call(this, f, !0)));
                            }
                            49 < o && d.appendChild(document.createTextNode("..."));
                        }
                    } else
                        var t = ':not([hidden]):not([data-hidden="true"]):not([data-divider="true"]):not([style*="display: none"])',
                    ...
                    d.childNodes.length || (d = L.text.call(this, { text: this.options.placeholder || this.options.noneSelectedText }, !0)),
                        (r.title = d.textContent.replace(/<[^>]*>?/g, "").trim()),
                        this.options.sanitize && h && S([d], i.options.whiteList, i.options.sanitizeFn),
                        (a.innerHTML = ""),
                        a.appendChild(d),
                        g.major < 4 && this.$newElement[0].classList.contains("bs3-has-addon") && ((s = r.querySelector(".filter-expand")), ((t = a.cloneNode(!0)).className = "filter-expand"), s ? r.replaceChild(t, s) : r.appendChild(t)),
                ...
                liHeight: function (e) {
                    if (e || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
                        ...
                        l.appendChild(a.cloneNode(!0)),
                            ...
                            n.appendChild(l),
                            c && i.appendChild(c),
                            d && ((u = document.createElement("input")), (d.className = "bs-searchbox"), (u.className = "form-control"), d.appendChild(u), i.appendChild(d)),
                            h && i.appendChild(h),
                            s.appendChild(n),
                            i.appendChild(s),
                            p && i.appendChild(p),
                        ...
                        (r = t.offsetHeight),
                            ...
                            (p = i.offsetWidth),
                            (o = { vert: v(h.paddingTop) + v(h.paddingBottom) + v(h.borderTopWidth) + v(h.borderBottomWidth), horiz: v(h.paddingLeft) + v(h.paddingRight) + v(h.borderLeftWidth) + v(h.borderRightWidth) }),
                            (h = { vert: o.vert + v(h.marginTop) + v(h.marginBottom) + 2, horiz: o.horiz + v(h.marginLeft) + v(h.marginRight) + 2 });
                ...
                setMenuSize: function (e) {
                    ...
                    if (
                        ...
                        (l = 3 < this.selectpicker.current.data.length ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0),
                            (i = this.sizeInfo.selectOffsetBot - this.sizeInfo.menuExtras.vert),
                            (s = l + c + d + h + p),
                            (o = Math.max(l - f.vert, 0)),
                            (t = (n = i = this.$newElement.hasClass(T.DROPUP) ? this.sizeInfo.selectOffsetTop - this.sizeInfo.menuExtras.vert : i) - c - d - h - p - f.vert);
                    ...
                    this.$menu.css({ "max-height": n + "px", overflow: "hidden", "min-height": s + "px" }),
                        this.$menuInner.css({ "max-height": t + "px", overflow: "hidden auto", "min-height": o + "px" }),
                        ...
                        this.$menu.toggleClass(T.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.sizeInfo.totalMenuWidth - r),
                    ...
                    this.liHeight(e),
                        ...
                        ((t = this),
                            ...
                            "auto" === this.options.size
                                ...
                                i.off("resize" + A + "." + this.selectId + ".setMenuSize scroll" + A + "." + this.selectId + ".setMenuSize")),
                ...
                selectPosition: function () {
                    ...
                    function e(e) {
                        ...
                        l.$bsContainer.addClass(e.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(T.DROPUP, e.hasClass(T.DROPUP)),
                            (s = e.offset()),
                            ...
                            (g.major < 4 || "static" === i) && ((t.top = s.top - n.top + o), (t.left = s.left - n.left)),
                ...
                setSelected: function (e, t) {
                    ...
                    s &&
                        (void 0 !== t && ((e.selected = t), e.option && (e.option.selected = t)),
                            ...
                            o ? (this.focusItem(s, e), (this.selectpicker.view.currentActive = s), (this.activeElement = s)) : this.defocusItem(s),
                            ...
                            o || n || !t || void 0 === this.prevActiveElement || ((e = this.prevActiveElement), this.defocusItem(e)));
                },
                setDisabled: function (e) {
                    ...
                    e &&
                        ((t = e.firstChild),
                            ...
                            t && ("4" <= g.major && t.classList.toggle(T.DISABLED, i), i ? (t.setAttribute("aria-disabled", i), t.setAttribute("tabindex", -1)) : (t.removeAttribute("aria-disabled"), t.setAttribute("tabindex", 0))));
                },
                isDisabled: function () {
                ...
                checkDisabled: function () {
                    this.isDisabled()
                        ? (this.$newElement[0].classList.add(T.DISABLED), this.$button.addClass(T.DISABLED).attr("aria-disabled", !0))
                        : this.$button[0].classList.contains(T.DISABLED) && (this.$newElement[0].classList.remove(T.DISABLED), this.$button.removeClass(T.DISABLED).attr("aria-disabled", !1));
                },
                    ...
                    t.data("spaceSelect", !1),
                        ...
                        this.$button.on("click.bs.dropdown.data-api", function (e) {
                            ...
                            I.options.allowClear &&
                                ((t = e.target),
                                    (i = I.$clearButton[0]),
                                    ((t = /MSIE|Trident/.test(window.navigator.userAgent) ? document.elementFromPoint(e.clientX, e.clientY) : t) !== i && t.parentElement !== i) ||
                                    (e.stopImmediatePropagation(),
                                        I.multiple
                                            ? I.deselectAll()
                                            : ((i = (t = I.$element[0]).value),
                                                (e = t.selectedIndex),
                                                (s = !!(s = t.options[e]) && I.selectpicker.main.data[s.liIndex]) && I.setSelected(s, !1),
                                                (t.selectedIndex = 0),
                                                (E = [e, !1, i]),
                                                I.$element.triggerNative("change")),
                                        I.$newElement.hasClass(T.SHOW) && (I.options.liveSearch && I.$searchbox.trigger("focus"), I.createView(!1)))),
                        ...
                        this.$menuInner.on("click", "li a", function (e, t) {
                            ...
                            if ((I.multiple && 1 !== I.options.maxOptions && e.stopPropagation(), e.preventDefault(), !I.isDisabled() && !i.parent().hasClass(T.DISABLED))) {
                                    ...
                                    if ((I.setSelected(o, !d), I.focusedParent.focus(), !1 !== f || !1 !== h)) {
                                        ...
                                        if ((f && n) || (h && t))
                                            if (f && 1 === f) (s.selectedIndex = -1), I.setOptionStatus(!0);
                                                ...
                                                d[2] && ((b = b.replace("{var}", d[2][1 < f ? 0 : 1])), (w = w.replace("{var}", d[2][1 < h ? 0 : 1]))),
                                                    I.$menu.append(k),
                                                    f && n && (k.append($("<div>" + b + "</div>")), (c = !1), I.$element.trigger("maxReached" + A)),
                                                    h && t && (k.append($("<div>" + w + "</div>")), (c = !1), I.$element.trigger("maxReachedGrp" + A)),
                                                    setTimeout(function () {
                                                        I.setSelected(o, !1);
                                                    }, 10),
                                ...
                                I.options.source.data && I.$element[0].appendChild(I.selectpicker.main.optionQueue),
                                    ...
                                    !c || (!I.multiple && r === s.selectedIndex) || ((E = [e.index, i.prop("selected"), l]), I.$element.triggerNative("change"));
                            }
                        }),
                        ...
                        this.$button
                            ...
                            .on("blur" + A, function (e) {
                                void 0 !== I.selectpicker.view.tabindex &&
                                    ...
                                    (I.$element[0].setAttribute("tabindex", I.selectpicker.view.tabindex), this.setAttribute("tabindex", -1), (I.selectpicker.view.tabindex = void 0));
                            }),
                        this.$element
                ...
                val: function (t) {
                    ...
                    return (
                        ...
                        this.$newElement.hasClass(T.SHOW) && (this.multiple ? this.setOptionStatus(!0) : "number" == typeof (s = (e.options[e.selectedIndex] || {}).liIndex) && this.setSelected(this.selectpicker.current.data[s], !0)),
                        this.render(),
                        (E = null),
                        this.$element
                    );
                ...
                toggle: function (e, t) {
                    ...
                    (e = e || window.event) && e.stopPropagation(),
                        !1 === i && ((e = this.$newElement[0].classList.contains(T.SHOW)), (i = (!0 === t && !1 === e) || (!1 === t && !0 === e))),
                    ...
                    if (!(112 <= e.which && e.which <= 123))
                        if (
                            ...
                            if ((e.which === Z && t && (e.preventDefault(), r.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), d)) {
                                if (!a.length) return;
                                -1 !== (d = (i = r.activeElement) ? Array.prototype.indexOf.call(i.parentElement.children, i) : -1) && r.defocusItem(i),
                                    e.which === C
                                        ...
                                        : (e.which !== O && !l) ||
                                        (++d + p >= r.selectpicker.view.canHighlight.length && (d = r.selectpicker.view.firstHighlightIndex),
                                            r.selectpicker.view.canHighlight[d + p] || (d = d + 1 + r.selectpicker.view.canHighlight.slice(d + p + 1).indexOf(!0))),
                                    e.preventDefault();
                                var u = p + d;
                                e.which === C
                                    ? 0 === p && d === a.length - 1
                                    ...
                                    (d === r.selectpicker.view.firstHighlightIndex
                                        ...
                                        : (s = r.selectpicker.current.data[u]) && (c = h < (n = s.position - r.sizeInfo.menuInnerHeight))),
                                ...
                                m.length &&
                                    ((p = 0),
                                        ...
                                        1 === f.length && (-1 === (p = m.indexOf(r.activeElement)) || p === m.length - 1 ? (p = 0) : p++),
                                        (l = m[p]),
                                        (c = 0 < h - (s = r.selectpicker.main.data[l]).position ? ((n = s.position - s.height), !0) : ((n = s.position - r.sizeInfo.menuInnerHeight), s.position > h + r.sizeInfo.menuInnerHeight)),
                            ...
                            t &&
                                ((e.which === w && !r.selectpicker.keydown.keyHistory) || e.which === J || (e.which === I && r.options.selectOnTab)) &&
                                (e.which !== w && e.preventDefault(),
                                    (r.options.liveSearch && e.which === w) || (r.$menuInner.find(".active a").trigger("click", !0), o.trigger("focus"), r.options.liveSearch || (e.preventDefault(), $(document).data("spaceSelect", !0))));
                        }
                },
                mobile: function () {
                ...
                destroy: function () {
                    this.$newElement.before(this.$element).remove(),
                        ...
                        this.$element.off(A).removeData("selectpicker").removeClass("bs-select-hidden selectpicker mobile-device"),
        ...
        ($.fn.selectpicker = oe),
            ...
            $(document)
                ...
                .on("keydown" + A, ".bootstrap-select [" + z.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', H.prototype.keydown)
                .on("focusin.modal", ".bootstrap-select [" + z.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function (e) {
                    e.stopPropagation();
                }),
